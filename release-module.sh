...
function copy_files() {
    ...
    rm "$QML_BASE/Opal/InfoCombo/private/ExtraTranslations.qml" || true
    rmdir --ignore-fail-on-non-empty "$QML_BASE/Opal/InfoCombo/private"
    ...
    printf "%s\n" \
        ...
        "}" "" > "$QML_BASE/Opal/InfoCombo/OpalInfoComboAttribution.qml"
}
